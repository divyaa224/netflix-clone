      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <div className="relative" ref={profileRef}>
            ...
            {/* Creator link */}
          <Link to="https://github.com/divyaa224" target="_blank" rel="noopener noreferrer" title="Creator">
  <img
    src="https://github.com/divyaa224.png"
    alt="Creator"
  ...
  />
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 bg-black rounded-lg p-4 flex flex-col gap-4">
          ...
          <Link to="https://github.com/divyaa224" target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-white">Creator</Link>
          {currentUser ? (
            <button
              onClick={handleLogout}
